...
//         productId: item.id,
//         variantId: item.variantId || null, // যদি variant না থাকে null দিবে
...
//       resetForm();
//       // window.location.href = "/order-success" // চাইলে রিডাইরেক্ট করো
//     } catch (error: any) {
...
//                   >
//                     {isLoading || isSubmitting ? "Placing Order..." : `Place Order – $${total.toFixed(2)}`}
//                   </button>
//                 </div>
//               </div>
//             </Form>
