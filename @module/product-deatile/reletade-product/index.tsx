...
const RelatedProduct = () => {
  ...
  return (
    <div className="container relative">
      <section className="w-full px-4 md:px-12 lg:px-24 py-10 mt-20  mb-15  relative">
        {/* Header */}
              ...
              <div className="relative border border-gray-200 rounded-md bg-white group overflow-hidden transition-all duration-300 w-full max-w-[226px] h-[350px] flex flex-col cursor-pointer">
                ...
                <div className="px-3 sm:px-4 py-2 flex flex-col gap-2 transition-all duration-300 flex-1">
                  ...
                  <button
                    ...
                    className="mt-auto inline-flex items-center justify-center gap-2 cursor-pointer py-2 px-4 rounded-[5px] bg-[#F7F7F7] text-[14px] text-[var(--main-color2)] font-medium capitalize opacity-0 translate-y-5 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300 hover:bg-black hover:text-white"
                  >
