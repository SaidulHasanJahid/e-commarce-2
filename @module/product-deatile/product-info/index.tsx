...
import { FaCcMastercard, FaCcPaypal, FaCcVisa, FaEbay } from "react-icons/fa";

const ProductInfo = () => {
  return (
    <div className="space-y-4">
      <h1 className="text-[34px] text-[#000000] font-semibold">Huness I16 ProMAX Smartphone</h1>
      <p className="text-[#000000] text-[14px]">👁️ 51 People are viewing this right now</p>
      <p className="text-[14px] text-red-500"> 🔥 110 Sold in 24 hour</p>
      <div className="text-[14px] space-y-4">
        <p className="text-[#666666]">
          Availability: <span className="text-[#000000]">In stock</span>
        </p>
        <p><span className="text-[#666666]">Product Code</span> : <span className="text-[#000000]">MBLHK</span></p>
        <p  className="text-[#666666]">
          Category :{" "}
        ...
        <p className="text-[#666666]">Tag : <span className="text-[#000000]"> phone, mobile, apple</span> </p>
      </div>

      <p className="text-[#666666] text-[14px] mt-10"> The timeless Lacoste tee gets an update in a super-comfortable mid-weight fabric. A versatile essential that goes with everything, finished with an iconic crocodile

</p>

      {/* Price */}
      <div className="flex items-center gap-3 mb-4">
        <span className="text-[#D52345] text-[28px]">€158</span>
...
<div className="w-[127px] h-[50px] flex justify-between bg-[#F7F7F7] rounded-[3px] overflow-hidden">
  {/* Minus button */}
  <button
    className="w-[40px] h-full transition-all duration-300 
               hover:bg-black hover:text-white flex items-center justify-center cursor-pointer"
  >
    <FiMinus />
  </button>
  ...
  className="flex-1 inline-flex items-center justify-center gap-2 
             bg-white border border-[var(--main-color2)] rounded-[3px] 
             px-6 py-3 h-[50px] font-medium text-sm 
             hover:bg-black hover:text-white transition-all duration-300 ease-in-out cursor-pointer "
>
...
<button
  className="w-[49px] h-[49px] flex items-center justify-center 
             border border-[var(--line)] rounded-[3px] bg-white 
...
>
  <BsArrowLeftRight />
    ...
    {/* Extra Links */}
{/* <div
  className="flex flex-wrap items-center gap-x-[30px] gap-y-[10px] 
             border-b border-[#666666] mb-[25px] pb-[25px]"
>
  ...
  <button className="flex items-center gap-1 text-[14px] text-[#000000] hover:text-red-500">
    <FiShare2 /> Share
      ...
      <p className="text-sm">Free shipping and returns on all orders over €396</p>
