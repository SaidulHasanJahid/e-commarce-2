...
import { addToCart } from "@/appstore/cart/cart-slice"; // তোমার কার্ট স্লাইসের পাথ ঠিক করো
  ...
  return (
    <div className="space-y-6 max-w-2xl mx-auto">
      ...
      <div className="flex items-end gap-4">
        <span className="text-4xl font-bold text-red-600">${totalPrice}</span>
        {oldTotal && (
          <>
            <span className="text-2xl text-gray-400 line-through">${oldTotal}</span>
